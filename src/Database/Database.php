...
namespace nguyenanhung\Frontend\Your_Project\Database;

use nguyenanhung\Frontend\Your_Project\Base\BaseCore;
use nguyenanhung\Frontend\Your_Project\Database\Traits\SignatureTable;
use nguyenanhung\MyDatabase\Model\BaseModel;

/**
 * Class Database
 *
 * @package   nguyenanhung\Frontend\Your_Project\Database
